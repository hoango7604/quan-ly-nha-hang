...
@Injectable()
export class EventInviteeService implements TableDataService<Invitee> {
	...
	public fetchData(pageIndex: number, pageSize: number, sortBy: string, sortType: string): Observable<Invitee[]> {
	...
	public get(id: string): Observable<Invitee> {
		const headers: HttpHeaders = this._apiRequestService.appendAccessToken();
	...
	public add(invitee: Invitee): Observable<Invitee> {
		return null;
	}
	...
	public createVisitorsAndAdd(data: Invitee[]): Observable<Invitee | any> {
		const headers: HttpHeaders = this._apiRequestService.appendAccessToken();
	...
	public update(data: Invitee): Observable<Invitee | any> {
		return null;
	}
	...
	public searchGlobal(keyword: string): Observable<Invitee[]> {
		return null;
	}
}
